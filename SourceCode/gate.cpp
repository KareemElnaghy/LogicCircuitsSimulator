...
void gate::setInputValue(int i, bool value)
{
  inputs[i].value = value;
}

vector<gate::dataStruct> gate::get_inputs() { return inputs; }    // Getter function returns inputs vector
...
gate::dataStruct gate::get_output() { return output; }    // Getter function returns output
...
int gate::get_delay_ps() { return delay_ps; }   // Getter function returns delay in ps                   
